...
public class AnimalFarm {
	...
	AnimalFarm() {
		 ...
		 * animal.
		 */
		JOptionPane.showMessageDialog(null, "choose from a cow a duck and a Doge and a cat and a llama");
		String animale = JOptionPane.showInputDialog("Whait iaes di favorito animale");
if
